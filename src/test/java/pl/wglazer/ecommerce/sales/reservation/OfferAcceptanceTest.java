...
public class OfferAcceptanceTest {
    ...
    void itAllowsToAcceptAnOffer() {
        ...
        String productId = thereIsProduct("Baseball Cap", BigDecimal.valueOf(34));
        ...
        assertReservationTotalMatchOffer(reservationDetails.getReservationId(), BigDecimal.valueOf(68));
    }
